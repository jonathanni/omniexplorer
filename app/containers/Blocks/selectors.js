...
const makeSelectLoading = () =>
  createSelector(selectBlocksDomain, (substate) => substate.loading);

const makeSelectPreviousBlock = () =>
  createSelector(selectBlocksDomain, (substate) => substate.previousBlock);

const makeSelectLatestBlock = () =>
  createSelector(selectBlocksDomain, (substate) => substate.latest);
